...
$scriptdir/../../../bin/bvd-add.pl $scriptdir/case_bvd_add_12_1.vcf
...
if [ $? -eq 0 ]; then
    echo "All case_bvd_add_12 are correct !!! Congratz"
else
    echo "Something went wrong in case_bvd_add_12 testing. See below "
    echo "$result"
fi

...
$scriptdir/../../../bin/bvd-add.pl $scriptdir/case_bvd_add_01_1.vcf -T colon_cancer,lung_cancer
...
if [ $? -eq 0 ]; then
    echo "All case_bvd_add_01 are correct !!! Congratz"
else
    echo "Something went wrong in case_bvd_add_01 testing. See below "
    echo "$result"
fi

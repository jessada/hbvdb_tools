...
$scriptdir/../../../bin/bvd-add.pl $scriptdir/case_bvd_add_41.vcf -T colon_cancer,lung_cancer --buildver hg19
...
if [ $? -eq 0 ]; then
    echo "All case_bvd_add_41 are correct !!! Congratz"
else
    echo "Something went wrong in case_bvd_add_41 testing. See below "
    echo "$result"
fi

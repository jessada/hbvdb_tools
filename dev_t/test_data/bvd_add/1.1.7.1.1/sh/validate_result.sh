...
cp $scriptdir/case_bvd_add_13_bvdb $scriptdir/../../../bin/DB/bvdb
cp $scriptdir/case_bvd_add_13_bvdb_chksum $scriptdir/../../../bin/DB/bvdb_chksum

$scriptdir/../../../bin/bvd-add.pl $scriptdir/case_bvd_add_13_2.vcf

result=$(diff $scriptdir/../../../bin/DB/bvdb $scriptdir/expected_result)

if [ $? -ne 0 ]; then
	echo "Something went wrong in case_bvd_add_13 testing. See below "
	echo "$result"
	exit 0
fi
...
echo "All case_bvd_add_13 are correct !!! Congratz"
